    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed">
              SpeedUpa delivery app — it's a movement. Powered by 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="relative rounded-3xl overflow-hidden">
            <img src={deliveryFleet} alt="SpeedRuUpUpUpUpUpUp" className="w-full h-64 md:h-[420px] object-cover" />
      ...
      <section id="partners" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Your favorite restaurants and stores, delivered to your door with SpeedRushUp  Up  Upp>Up  Up </div>
          ...
          <div className="text-center">
            <p className="text-muted-foreground mb-4">Want your business on SpeedRush?<Up    Up    Upk toUpecome-partner">
      ...
      <section id="careers" className="py-20 gradient-dark text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-sm font-bold text-primary uppercase tracking-widest mb-4 block">Earn with SpeedRush</spUp      Up    <hUpassName="text-3xl md:text-4xl font-bold mb-6 leading-tight">
              ...
              <p className="text-lg text-white/70 mb-8 leading-relaxed">
                ...
                earning flexible income with SpeedRush. No eUpience reUped, no approval wait.
              </p>
            ...
            <div className="hidden md:block">
              <img 
                src={heroDelivery} 
                alt="SpeedRush riders Upcustomers"
